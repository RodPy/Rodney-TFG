...
\small \textit{Nota}.$^{\ast}$ Regi\'on Metropolitana de Asunci\'on. \\$^{\ast \ast}$Expansi\'on Urbana desordenada. \textit{Fuente}:Adaptado de\cite{salas-duenas-2015}.
\end{table}
...
\begin{itemize}
    ...
    \begin{figure}[ht]
        \centering
        \label{fig:RTD}
        \includegraphics[scale=0.6]{Imagenes/cap2/RTF.png}\\
        \bigskip
        \raggedright
        \caption {RTD de elemento en espiral }\textbf{Fuente}. Extra\'ido de \cite{prelectronics_fundamentos_nodate}
    \end{figure}
    % [RR] 15MAYO2022
    ...
    \begin{figure}[ht]
        ...
        \centering
        \label{fig:radiante}
        \includegraphics[scale=0.6]{Imagenes/cap2/radiante.jpg}\\
        \bigskip
        \raggedright
        \caption {Medici\'on de temperatura por radiaci\'on infraroja}  \textbf{Fuente}. Extra\'ido de \cite{omega_como_nodate}
    \end{figure}
